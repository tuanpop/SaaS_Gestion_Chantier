'use client'
// app/admin/chantiers/[id]/propositions/page.tsx
// Page propositions bot pour l'admin
//
// Implements: US-071, US-072, US-075, US-076, US-077
// RBAC : admin UNIQUEMENT — protégé par middleware
// EXI-8-06 BINDING : JSX pur — ProposalQueueItem
// data-testid="propositions-page-admin"
...
export default function AdminPropositionsPage({ params }: PageProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-[var(--color-text-muted)] mb-4">
        Validez, modifiez ou rejetez les propositions générées par l&apos;assistant Claw.
      </p>
      ...
      {!loading && proposals.length === 0 && (
        ...
        >
          ...
          <p className="text-sm text-muted">
            Claw génère des propositions lorsque l&apos;équipe mentionne des actions dans le chat.
          </p>
        </div>
      )}

      <div
        data-testid="propositions-list-admin"
        className="space-y-3"
      >
